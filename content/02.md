...
### ✅ Test by Attaching the Role to an EC2 Instance
...
✔ Secure access for applications running on AWS  
...
```
### ✅ Testing an Assumed Role from AWS Console

1. **Sign in to the AWS Management Console** using your IAM user credentials.

2. **Switch Role**:
   - Click on your username (top-right corner) → **Switch Role**
...
3. **Verify Role Permissions**:
   ...
   - If you see “Access Denied,” the role’s permissions or trust policy may need adjustment

4. **Switch Back**:
   - Click on the role name (top-right) → **Back to your original user**
...
- Go to **AWS Organizations** console → **C**
...
## ✅ Steps to Create and Attach SCP
...
### ✅ AWS Organizations and SCP (Service Control Policies)
...
### ✅ Using SCPs
1. Navigate **AWS Organizations → Policies → Create Policy**
